...
const CardBahtsulMasail = (propsIn: Props) => {
  return (
    <div className="flex flex-row items-center justify-between overflow-hidden relative rounded-md bg-light-card dark:bg-dark-accent w-full h-20 gap-2">
      <div className="h-20 w-24 flex-none">
        <img
          ...
          alt="image"
          className="h-20 w-24 object-cover bg-cover object-bottom p-[5px] rounded-lg"
        />
      </div>
      <div className="flex flex-grow flex-col items-start justify-around gap-2">
        <h3 className="text-[11px] md:text-base leading-relaxed font-normal">
